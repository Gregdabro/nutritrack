...
- [ ] Mongoose схема: Product
- [ ] CRUD /products + текстовый поиск
- [ ] Zod-схемы для продуктов
- [ ] Страница /products — список + поиск
- [ ] Форма создания/редактирования продукта
- [ ] Наполнить базу стартовыми продуктами (20-30 штук с БЖУ)

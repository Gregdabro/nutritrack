...
- [x] reminderService.js — утренние и вечерние напоминания
- [x] Настройки напоминаний в /settings

### Спринт 8 — Полировка MVP (5-7 дней)

- [x] Проверка покрытия Zod-валидацией всех эндпоинтов
- [x] Проверка обработки ошибок (typed errors везде)
- [x] Проверка логирования (все критические пути)
- [x] Загрузочные состояния и skeleton screens
- [x] Пустые состояния (empty states) для всех страниц
- [x] Тест на нетехническом пользователе

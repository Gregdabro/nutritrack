...
- Если указана "порция" блюда или рецепта (например, "1 порция вафли"), возвращай servings вместо grams
- Если продукт неоднозначен, включи его с пометкой "uncertain": true

Формат:
[{"name": "название", "grams": 100, "servings": null, "uncertain": false}, {"name": "вафли", "grams": null, "servings": 1, "uncertain": false}]`;
